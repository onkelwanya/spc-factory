...
export function handleRegionAndCountrySelection(html: JQuery<HTMLElement>): void {
...
function updateCountryOptions(countrySelect: JQuery<HTMLElement>, countries: string[]): void {
    countrySelect.empty();
